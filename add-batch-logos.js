...
const lessons = [
  {
    path: 'C:/Projects/Quantum-Scale/genrok-app/public/lessons/emotional-gap/lesson.html',
    brand: 'Liquid Death',
    brandImage: 'https://pqvvrljykfvhpyvxmwzb.supabase.co/storage/v1/object/public/images/Liquid-Death-Emblem.png',
    hookSearch: "That gap made them $130M.' }"
  },
  {
    path: 'C:/Projects/Quantum-Scale/genrok-app/public/lessons/biz-operator-mindset/lesson.html',
    brand: 'Gymshark',
    brandImage: 'https://pqvvrljykfvhpyvxmwzb.supabase.co/storage/v1/object/public/images/Gymshark_Limited_Logo.png',
    hookSearch: "what happened next' }"
  }
];
