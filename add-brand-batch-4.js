...
const lessons = [
  {
    path: 'C:/Projects/Quantum-Scale/genrok-app/public/lessons/information-asymmetry/lesson.html',
    brand: 'Prada',
    brandImage: 'https://pqvvrljykfvhpyvxmwzb.supabase.co/storage/v1/object/public/images/Prada-logo.jpg',
    hookSearch: "irresistible desire.' }"
  },
  {
    path: 'C:/Projects/Quantum-Scale/genrok-app/public/lessons/paradox-of-choice/lesson.html',
    brand: 'Chipotle',
    brandImage: 'https://pqvvrljykfvhpyvxmwzb.supabase.co/storage/v1/object/public/images/Chipotle_Mexican_Grill_logo.svg.png',
    hookSearch: "right now.' }"
  }
];
