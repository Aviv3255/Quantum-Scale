...
const lessons = [
  {
    path: 'C:/Projects/Quantum-Scale/genrok-app/public/lessons/celebrity-gifting-flywheel/lesson.html',
    brand: 'Rolex',
    brandImage: 'https://pqvvrljykfvhpyvxmwzb.supabase.co/storage/v1/object/public/images/Logo_da_Rolex.png',
    hookSearch: "paid advertising can never match.' }"
  },
  {
    path: 'C:/Projects/Quantum-Scale/genrok-app/public/lessons/anchor-moments/lesson.html',
    brand: 'Ralph Lauren',
    brandImage: 'https://pqvvrljykfvhpyvxmwzb.supabase.co/storage/v1/object/public/images/polo_ralph_lauren-logo_brandlogos.net_9uyue-512x1003.png',
    hookSearch: "entire catalog.' }"
  }
];
