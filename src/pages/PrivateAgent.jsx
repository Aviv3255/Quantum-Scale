...
import { ExternalLink, CheckCircle, Truck, Package, DollarSign, MessageCircle, Globe, Zap, ShoppingBag, CreditCard, Box, TrendingUp, ChevronDown, ArrowRight } from 'lucide-react';
    ...
    <div className="min-h-screen" style={{ background: '#F9FAFB' }}>
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl mb-3" style={{ 
            color: '#6B7280',
            maxWidth: '800px', 
            margin: '0 auto 12px' 
          }}>
          ...
          <p className="text-lg mb-10" style={{ 
            ...
            Partnership with China's largest logistics company, working exclusively with dropshippers. 
            From 1 order/month to 50,000 orders/day.
          </p>
        ...
        {/* Comparison Table */}
        <div className="p-8 rounded-2xl mb-16" style={{
          background: '#FFFFFF',
          border: '1px solid #E5E7EB',
          boxShadow: '0 2px 8px rgba(0, 0, 0, 0.04)'
        }}>
          ...
          <div className="relative max-w-4xl mx-auto">
            ...
            <div className="space-y-6">
              {steps.map((step, idx) => (
                <div 
                  key={idx}
                  className="ml-20 p-6 rounded-xl relative"
                  style={{
                    background: '#FFFFFF',
                    border: '1px solid #E5E7EB',
                    boxShadow: '0 2px 8px rgba(0, 0, 0, 0.04)'
                ...
                >
                  {/* Step Number Circle */}
                  <div 
                    className="absolute -left-[72px] top-1/2 transform -translate-y-1/2 w-14 h-14 rounded-full flex items-center justify-center font-bold text-lg"
                    style={{ 
        ...
        {/* FAQ Accordion */}
        <div className="p-8 rounded-2xl mb-12" style={{
          background: '#FFFFFF',
          border: '1px solid #E5E7EB',
          boxShadow: '0 2px 8px rgba(0, 0, 0, 0.04)'
        }}>
        ...
        <div className="text-center">
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center gap-3 px-10 py-5 text-xl font-bold rounded-xl transition-all"
            style={{
              background: 'linear-gradient(135deg, #3B82F6 0%, #2563EB 100%)',
              color: '#FFFFFF',
              boxShadow: '0 8px 24px rgba(59, 130, 246, 0.3)'
