...
export default function WebUIInspiration() {
  const websites = [
    {
      name: 'TRIARE',
    ...
    {
      name: 'Osklen',
      image: 'https://assets.awwwards.com/awards/media/cache/thumb_880_660/submissions/2024/12/67607d16f3de0768569941.png',
