...
import { ExternalLink, Copy, Check, Target, Zap, TrendingUp, Star } from 'lucide-react';
...
export default function ShrineTheme() {
  ...
  const testimonials = [
    {
      image: 'https://shrine.io/cdn/shop/files/9a_4554b58e-d3e9-4fda-96af-69dff22b8360.png?v=1739860052&width=1000',
      alt: 'Customer testimonial showing conversion improvement'
    },
    {
      image: 'https://shrine.io/cdn/shop/files/10a_1a0452ea-1075-44b0-8525-fee0d10fa7a8.png?v=1739860055&width=1000',
    ...
    {
      image: 'https://shrine.io/cdn/shop/files/6a_f90e9089-8424-42aa-8e38-45338769b37d.png?v=1739860032&width=1000',
      alt: 'Customer testimonial'
    },
    {
      image: 'https://shrine.io/cdn/shop/files/1a_b633c2b7-cd9d-4870-98e5-269ce12dfadd.png?v=1739859993&width=1000',
      alt: 'Customer feedback'
    },
    {
      image: 'https://shrine.io/cdn/shop/files/5a_77d4e126-b35d-4e51-8476-ba13d8ddb530.png?v=1760274017&width=1000',
      alt: 'Customer results'
    },
    {
      image: 'https://shrine.io/cdn/shop/files/11a_4036dc55-ab53-4232-abb0-08e1cd0abffd.png?v=1739860059&width=1000',
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-lg mb-10" style={{ 
            ...
            We've partnered with Shrine to bring you the most powerful eCommerce theme on the market.
            Trusted by top brands worldwide, Shrine combines blazing speed, conversion psychology, 
            and premium design in one elegant package.
          </p>

          {/* Coupon Box */}
          <div className="p-6 rounded-2xl mb-8 max-w-2xl mx-auto" style={{
            background: '#FFFFFF',
            border: '1px solid #E5E7EB',
            boxShadow: '0 2px 8px rgba(0, 0, 0, 0.04)'
          }}>
            <h3 className="text-xl font-bold mb-3" style={{ color: '#1E1E1E' }}>
            ...
            <a
              ...
              className="inline-flex items-center gap-2 px-8 py-3 text-base font-bold rounded-xl transition-all"
              style={{
        ...
        {/* Benefits Section */}
        <div className="p-10 rounded-2xl mb-16" style={{
          background: '#FFFFFF',
          border: '1px solid #E5E7EB',
          boxShadow: '0 2px 8px rgba(0, 0, 0, 0.04)'
        }}>
            ...
            {benefits.map((benefit, idx) => (
              ...
              >
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="font-bold text-xl mb-2" style={{ color: '#1E1E1E' }}>
                      {benefit.title}
                    </h3>
        ...
        <div className="text-center">
          <div className="p-10 rounded-2xl max-w-3xl mx-auto" style={{
            background: '#FFFFFF',
            border: '1px solid #E5E7EB',
            boxShadow: '0 2px 8px rgba(0, 0, 0, 0.04)'
          }}>
            <h3 className="text-3xl font-bold mb-4" style={{ color: '#1E1E1E', fontFamily: 'Poppins, sans-serif' }}>
              We personally use Shrine for all our eCommerce stores
            </h3>
            <p className="mb-8 text-lg" style={{ color: '#6B7280' }}>
              That's why we secured an exclusive 20% discount for you. Simply install through our link and use code <strong style={{ color: '#3B82F6' }}>QUANTUMSCALE</strong> at checkout.
            </p>
            <a
              href="https://shrinesolutions.com/?ref=0d9fe741"
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-3 px-10 py-4 text-lg font-bold rounded-xl transition-all"
              style={{
                background: 'linear-gradient(135deg, #3B82F6 0%, #2563EB 100%)',
                color: '#FFFFFF',
