 ...
 * Elite design for A/B comparisons
 */
    ...
    <div className={`${bgClass} p-8 rounded-2xl`}>
      ...
      <div className="max-w-xl mx-auto">
        ...
        >
          <div className="flex items-center justify-between mb-2">
            <div className="flex items-center gap-2">
              ...
              />
              <span className={`text-sm font-medium ${textClass}`}>{labelA}</span>
            </div>
            <span className={`text-sm ${mutedClass}`}>{itemA.label}</span>
          </div>
          <div className={`h-12 ${barBgClass} rounded-lg overflow-hidden relative`}>
            <motion.div
        ...
        >
          <div className="flex items-center justify-between mb-2">
            <div className="flex items-center gap-2">
              ...
              />
              <span className={`text-sm font-medium ${textClass}`}>{labelB}</span>
            </div>
            <span className={`text-sm ${mutedClass}`}>{itemB.label}</span>
          </div>
          <div className={`h-12 ${barBgClass} rounded-lg overflow-hidden relative`}>
            <motion.div
              className="h-full rounded-lg flex items-center justify-end pr-4"
        ...
        >
          ...
          >
            <span className={mutedClass}>Improvement:</span>
            <span
