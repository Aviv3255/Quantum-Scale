...
export const LESSON_COMPONENTS = {
  ...
  slides: [
    {
      ...
      description: 'Lesson intro with animated icons, title, learning goals, and duration',
      props: ['title', 'subtitle', 'learningGoals', 'duration', 'darkMode'],
    },
    {
      id: 'QuizSlide',
      name: 'Quiz Slide',
  ...
  content: [
    ...
    },
    {
      ...
      props: ['headline', 'subheadline', 'body', 'alignment', 'size', 'darkMode'],
    },
  ],
  ...
  charts: [
    {
      ...
      props: ['data', 'title', 'subtitle', 'valuePrefix', 'valueSuffix', 'showTrend', 'accentColor', 'darkMode'],
    },
    {
      id: 'BarChart',
      name: 'Bar Chart',
      ...
      props: ['data', 'title', 'subtitle', 'maxValue', 'showValues', 'horizontal', 'accentColor', 'darkMode'],
    },
    {
      id: 'AreaChart',
      name: 'Area Chart',
      ...
      props: ['data', 'title', 'subtitle', 'accentColor', 'showGrid', 'darkMode'],
    },
    {
      id: 'DonutChart',
      name: 'Donut Chart',
      ...
      props: ['data', 'centerValue', 'centerLabel', 'title', 'size', 'thickness', 'darkMode'],
    },
    {
      id: 'FunnelChart',
      name: 'Funnel Chart',
      ...
      props: ['data', 'title', 'subtitle', 'showConversion', 'darkMode'],
    },
    {
      id: 'RadarChart',
      name: 'Radar Chart',
      ...
      props: ['data', 'maxValue', 'title', 'accentColor', 'showLabels', 'darkMode'],
    },
    {
      id: 'ProgressRing',
      name: 'Progress Ring',
      ...
      props: ['value', 'maxValue', 'size', 'thickness', 'label', 'sublabel', 'accentColor', 'showPercent', 'darkMode'],
    },
    {
      id: 'Heatmap',
      name: 'Heatmap',
      ...
      props: ['data', 'rows', 'cols', 'title', 'minColor', 'maxColor', 'showValues', 'darkMode'],
    },
  ],
  ...
  data: [
    ...
    },
    {
      ...
      props: ['metrics', 'title', 'columns', 'darkMode'],
    },
  ],
  ...
  comparison: [
    ...
    },
    {
      ...
      props: ['itemA', 'itemB', 'title', 'labelA', 'labelB', 'colorA', 'colorB', 'darkMode'],
    },
  ],
  ...
  sequential: [
    {
      ...
      props: ['items', 'title', 'accentColor', 'darkMode'],
    },
    {
      id: 'ProcessSteps',
      name: 'Process Steps',
      ...
      props: ['steps', 'title', 'currentStep', 'accentColor', 'darkMode'],
    },
  ],
  ...
  emphasis: [
    {
      ...
      props: ['quote', 'author', 'role', 'accentColor', 'darkMode'],
    },
    {
      id: 'SocialProof',
      name: 'Social Proof',
      ...
      props: ['stat', 'label', 'description', 'type', 'crowdSize', 'accentColor', 'darkMode'],
    },
    {
      id: 'IconGrid',
      name: 'Icon Grid',
      ...
      props: ['items', 'title', 'columns', 'accentColor', 'darkMode'],
    },
  ],
};
