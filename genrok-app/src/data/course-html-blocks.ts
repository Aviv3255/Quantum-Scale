...
(function() {
  ...
  'ab-test-results':
    `
<div style="all:initial;display:block;position:relative;left:50%;right:50%;margin-left:-50vw;margin-right:-50vw;width:100vw;min-width:100vw;background:linear-gradient(135deg,#8E5DFF 0%,#6B42CC 100%);padding:60px 20px;box-sizing:border-box;overflow-x:hidden;font-family:'Open Sans',sans-serif;">
<div style="all:initial;display:block;max-width:900px;margin:0 auto;text-align:center;padding:0;box-sizing:border-box;">
<h1 style="all:initial;display:block;font-family:'Open Sans',sans-serif;font-weight:800;font-size:48px;line-height:1.2;color:#ffffff;margin:0 0 20px 0;padding:0;text-align:center;box-sizing:border-box;">37 Proven A/B Test Results</h1>
<p style="all:initial;display:block;font-family:'Open Sans',sans-serif;font-size:22px;line-height:1.5;color:#f0e6ff;margin:0 0 40px 0;padding:0;text-align:center;font-weight:400;box-sizing:border-box;">Real data from real tests that increased conversions by up to 44%</p>
<p style="all:initial;display:block;font-family:'Open Sans',sans-serif;font-size:44px;line-height:1.2;color:#ffffff;margin:0 0 10px 0;padding:0;text-align:center;font-weight:800;box-sizing:border-box;"><span style="all:initial;display:inline;text-decoration:line-through;color:#d4b5ff;font-size:32px;">$70</span> &rarr; $29</p>
<button style="all:initial;display:block;margin:30px auto 0;padding:18px 50px;background:linear-gradient(135deg,#8E5DFF 0%,#6B42CC 100%);border:2px solid #ffffff;border-radius:50px;color:#ffffff;font-weight:800;font-size:18px;cursor:pointer;font-family:'Open Sans',sans-serif;box-sizing:border-box;transition:all 0.3s ease;" data-variant-id="43187792281693">GET ACCESS NOW</button>
</div>
</div>` +
    `
<div style="all:initial;display:block;position:relative;left:50%;right:50%;margin-left:-50vw;margin-right:-50vw;width:100vw;min-width:100vw;background:#ffffff;padding:60px 20px;box-sizing:border-box;overflow-x:hidden;font-family:'Open Sans',sans-serif;">
<div style="all:initial;display:block;max-width:900px;margin:0 auto;padding:0;box-sizing:border-box;">
<div style="all:initial;display:grid;grid-template-columns:repeat(auto-fit,minmax(250px,1fr));gap:30px;margin:0;padding:0;box-sizing:border-box;">
<div style="all:initial;display:block;text-align:center;padding:0;margin:0;box-sizing:border-box;">
<img src="https://media.tenor.com/fI75_YYZ9rkAAAAM/profit.gif" style="all:initial;display:block;width:100%;max-width:250px;height:auto;margin:0 auto 20px;padding:0;border:none;border-radius:12px;box-sizing:border-box;">
<p style="all:initial;display:block;font-family:'Open Sans',sans-serif;font-size:18px;line-height:1.6;color:#333333;margin:0;padding:0;font-weight:700;box-sizing:border-box;"><span style="all:initial;display:inline;color:#8E5DFF;font-weight:800;">+44%</span> Conversion Rate</p>
</div>
<div style="all:initial;display:block;text-align:center;padding:0;margin:0;box-sizing:border-box;">
<img src="https://media.tenor.com/1nR6u4lVd8YAAAAC/money-profit.gif" style="all:initial;display:block;width:100%;max-width:250px;height:auto;margin:0 auto 20px;padding:0;border:none;border-radius:12px;box-sizing:border-box;">
<p style="all:initial;display:block;font-family:'Open Sans',sans-serif;font-size:18px;line-height:1.6;color:#333333;margin:0;padding:0;font-weight:700;box-sizing:border-box;"><span style="all:initial;display:inline;color:#8E5DFF;font-weight:800;">+180%</span> Average Order Value</p>
</div>
<div style="all:initial;display:block;text-align:center;padding:0;margin:0;box-sizing:border-box;">
<img src="https://media.tenor.com/KJ2UY6I_cZUAAAAM/success-winner.gif" style="all:initial;display:block;width:100%;max-width:250px;height:auto;margin:0 auto 20px;padding:0;border:none;border-radius:12px;box-sizing:border-box;">
<p style="all:initial;display:block;font-family:'Open Sans',sans-serif;font-size:18px;line-height:1.6;color:#333333;margin:0;padding:0;font-weight:700;box-sizing:border-box;"><span style="all:initial;display:inline;color:#8E5DFF;font-weight:800;">+320%</span> Revenue Growth</p>
</div>
</div>
</div>
</div>` +
    `
<div style="all:initial;display:block;position:relative;left:50%;right:50%;margin-left:-50vw;margin-right:-50vw;width:100vw;min-width:100vw;background:linear-gradient(135deg,#3d3d3d 0%,#1a1a1a 100%);padding:60px 20px;box-sizing:border-box;overflow-x:hidden;font-family:'Open Sans',sans-serif;">
<div style="all:initial;display:block;max-width:900px;margin:0 auto;padding:0;box-sizing:border-box;">
<h2 style="all:initial;display:block;font-family:'Open Sans',sans-serif;font-weight:800;font-size:42px;line-height:1.2;color:#ffffff;margin:0 0 50px 0;padding:0;text-align:center;box-sizing:border-box;">The 3-Test Impact System</h2>
<div style="all:initial;display:grid;grid-template-columns:repeat(auto-fit,minmax(250px,1fr));gap:30px;margin:0;padding:0;box-sizing:border-box;">
<div style="all:initial;display:block;background:rgba(142,93,255,0.1);border:2px solid #8E5DFF;border-radius:16px;padding:30px;margin:0;text-align:center;box-sizing:border-box;">
<p style="all:initial;display:block;font-family:'Open Sans',sans-serif;font-size:48px;line-height:1;color:#8E5DFF;margin:0 0 15px 0;padding:0;font-weight:800;box-sizing:border-box;">1</p>
<p style="all:initial;display:block;font-family:'Open Sans',sans-serif;font-size:20px;line-height:1.5;color:#ffffff;margin:0;padding:0;font-weight:700;box-sizing:border-box;">Button Color</p>
<p style="all:initial;display:block;font-family:'Open Sans',sans-serif;font-size:14px;line-height:1.6;color:#cccccc;margin:10px 0 0 0;padding:0;font-weight:400;box-sizing:border-box;">+6% conversion just by changing button color</p>
</div>
<div style="all:initial;display:block;background:rgba(142,93,255,0.1);border:2px solid #8E5DFF;border-radius:16px;padding:30px;margin:0;text-align:center;box-sizing:border-box;">
<p style="all:initial;display:block;font-family:'Open Sans',sans-serif;font-size:48px;line-height:1;color:#8E5DFF;margin:0 0 15px 0;padding:0;font-weight:800;box-sizing:border-box;">2</p>
<p style="all:initial;display:block;font-family:'Open Sans',sans-serif;font-size:20px;line-height:1.5;color:#ffffff;margin:0;padding:0;font-weight:700;box-sizing:border-box;">Copy Testing</p>
<p style="all:initial;display:block;font-family:'Open Sans',sans-serif;font-size:14px;line-height:1.6;color:#cccccc;margin:10px 0 0 0;padding:0;font-weight:400;box-sizing:border-box;">+22% lift from subtle headline changes</p>
</div>
<div style="all:initial;display:block;background:rgba(142,93,255,0.1);border:2px solid #8E5DFF;border-radius:16px;padding:30px;margin:0;text-align:center;box-sizing:border-box;">
<p style="all:initial;display:block;font-family:'Open Sans',sans-serif;font-size:48px;line-height:1;color:#8E5DFF;margin:0 0 15px 0;padding:0;font-weight:800;box-sizing:border-box;">3</p>
<p style="all:initial;display:block;font-family:'Open Sans',sans-serif;font-size:20px;line-height:1.5;color:#ffffff;margin:0;padding:0;font-weight:700;box-sizing:border-box;">Layout Design</p>
<p style="all:initial;display:block;font-family:'Open Sans',sans-serif;font-size:14px;line-height:1.6;color:#cccccc;margin:10px 0 0 0;padding:0;font-weight:400;box-sizing:border-box;">+16% conversion from optimized layout</p>
</div>
</div>
</div>
</div>` +
    `
<div style="all:initial;display:block;position:relative;left:50%;right:50%;margin-left:-50vw;margin-right:-50vw;width:100vw;min-width:100vw;background:#f5f5f5;padding:60px 20px;box-sizing:border-box;overflow-x:hidden;font-family:'Open Sans',sans-serif;">
<div style="all:initial;display:block;max-width:900px;margin:0 auto;padding:0;box-sizing:border-box;">
<h2 style="all:initial;display:block;font-family:'Open Sans',sans-serif;font-weight:800;font-size:42px;line-height:1.2;color:#000000;margin:0 0 50px 0;padding:0;text-align:center;box-sizing:border-box;">Before vs After: Real Results</h2>
<div style="all:initial;display:block;overflow-x:auto;margin:0;padding:0;box-sizing:border-box;">
<table style="all:initial;display:table;width:100%;border-collapse:collapse;margin:0;padding:0;box-sizing:border-box;font-family:'Open Sans',sans-serif;">
<tr style="all:initial;display:table-row;margin:0;padding:0;">
<th style="all:initial;display:table-cell;padding:15px;text-align:left;background:#ffffff;border:1px solid #ddd;font-weight:700;color:#333333;margin:0;box-sizing:border-box;">Metric</th>
<th style="all:initial;display:table-cell;padding:15px;text-align:center;background:#f0f0f0;border:1px solid #ddd;font-weight:700;color:#666666;margin:0;box-sizing:border-box;">Without Tests</th>
<th style="all:initial;display:table-cell;padding:15px;text-align:center;background:#8E5DFF;border:1px solid #8E5DFF;font-weight:700;color:#ffffff;margin:0;box-sizing:border-box;">With Tests</th>
</tr>
<tr style="all:initial;display:table-row;margin:0;padding:0;">
<td style="all:initial;display:table-cell;padding:15px;text-align:left;background:#ffffff;border:1px solid #ddd;color:#333333;margin:0;box-sizing:border-box;">Conversion Rate</td>
<td style="all:initial;display:table-cell;padding:15px;text-align:center;background:#f0f0f0;border:1px solid #ddd;color:#666666;margin:0;box-sizing:border-box;">1.5%</td>
<td style="all:initial;display:table-cell;padding:15px;text-align:center;background:#8E5DFF;border:1px solid #8E5DFF;color:#ffffff;font-weight:700;margin:0;box-sizing:border-box;">6.6%</td>
</tr>
<tr style="all:initial;display:table-row;margin:0;padding:0;">
<td style="all:initial;display:table-cell;padding:15px;text-align:left;background:#ffffff;border:1px solid #ddd;color:#333333;margin:0;box-sizing:border-box;">Avg Order Value</td>
<td style="all:initial;display:table-cell;padding:15px;text-align:center;background:#f0f0f0;border:1px solid #ddd;color:#666666;margin:0;box-sizing:border-box;">$67</td>
<td style="all:initial;display:table-cell;padding:15px;text-align:center;background:#8E5DFF;border:1px solid #8E5DFF;color:#ffffff;font-weight:700;margin:0;box-sizing:border-box;">$188</td>
</tr>
<tr style="all:initial;display:table-row;margin:0;padding:0;">
<td style="all:initial;display:table-cell;padding:15px;text-align:left;background:#ffffff;border:1px solid #ddd;color:#333333;margin:0;box-sizing:border-box;">ROI per $1 Ad Spend</td>
<td style="all:initial;display:table-cell;padding:15px;text-align:center;background:#f0f0f0;border:1px solid #ddd;color:#666666;margin:0;box-sizing:border-box;">$0.98</td>
<td style="all:initial;display:table-cell;padding:15px;text-align:center;background:#8E5DFF;border:1px solid #8E5DFF;color:#ffffff;font-weight:700;margin:0;box-sizing:border-box;">$4.20</td>
</tr>
</table>
</div>
</div>
...
<div style="all:initial;display:block;position:relative;left:50%;right:50%;margin-left:-50vw;margin-right:-50vw;width:100vw;min-width:100vw;background:#ffffff;padding:60px 20px;box-sizing:border-box;overflow-x:hidden;font-family:'Open Sans',sans-serif;">
<div style="all:initial;display:block;max-width:900px;margin:0 auto;padding:0;box-sizing:border-box;">
<h2 style="all:initial;display:block;font-family:'Open Sans',sans-serif;font-weight:800;font-size:42px;line-height:1.2;color:#000000;margin:0 0 50px 0;padding:0;text-align:center;box-sizing:border-box;">Frequently Asked Questions</h2>
<div style="all:initial;display:block;margin:0;padding:0;box-sizing:border-box;">
<div style="all:initial;display:block;background:#f9f9f9;border-left:4px solid #8E5DFF;padding:20px;margin:0 0 15px 0;border-radius:8px;cursor:pointer;box-sizing:border-box;" onclick="this.nextElementSibling.style.display=this.nextElementSibling.style.display==='none'?'block':'none';">
<p style="all:initial;display:block;font-family:'Open Sans',sans-serif;font-weight:700;font-size:16px;color:#333333;margin:0;padding:0;box-sizing:border-box;">How do I run my first A/B test?</p>
</div>
<div style="all:initial;display:none;background:#ffffff;border:1px solid #ddd;padding:15px;margin:0 0 15px 0;border-radius:8px;box-sizing:border-box;">
<p style="all:initial;display:block;font-family:'Open Sans',sans-serif;font-size:14px;line-height:1.6;color:#666666;margin:0;padding:0;box-sizing:border-box;">You'll get a complete step-by-step guide with templates, tools, and real examples you can copy immediately.</p>
</div>
<div style="all:initial;display:block;background:#f9f9f9;border-left:4px solid #8E5DFF;padding:20px;margin:0 0 15px 0;border-radius:8px;cursor:pointer;box-sizing:border-box;" onclick="this.nextElementSibling.style.display=this.nextElementSibling.style.display==='none'?'block':'none';">
<p style="all:initial;display:block;font-family:'Open Sans',sans-serif;font-weight:700;font-size:16px;color:#333333;margin:0;padding:0;box-sizing:border-box;">What if my traffic is low?</p>
</div>
<div style="all:initial;display:none;background:#ffffff;border:1px solid #ddd;padding:15px;margin:0 0 15px 0;border-radius:8px;box-sizing:border-box;">
<p style="all:initial;display:block;font-family:'Open Sans',sans-serif;font-size:14px;line-height:1.6;color:#666666;margin:0;padding:0;box-sizing:border-box;">The methods work at any traffic level. You'll learn how to statistically validate results even with limited visitors.</p>
</div>
<div style="all:initial;display:block;background:#f9f9f9;border-left:4px solid #8E5DFF;padding:20px;margin:0 0 15px 0;border-radius:8px;cursor:pointer;box-sizing:border-box;" onclick="this.nextElementSibling.style.display=this.nextElementSibling.style.display==='none'?'block':'none';">
<p style="all:initial;display:block;font-family:'Open Sans',sans-serif;font-weight:700;font-size:16px;color:#333333;margin:0;padding:0;box-sizing:border-box;">Can I use these on Shopify?</p>
</div>
<div style="all:initial;display:none;background:#ffffff;border:1px solid #ddd;padding:15px;margin:0 0 15px 0;border-radius:8px;box-sizing:border-box;">
<p style="all:initial;display:block;font-family:'Open Sans',sans-serif;font-size:14px;line-height:1.6;color:#666666;margin:0;padding:0;box-sizing:border-box;">Yes. All 37 tests are designed specifically for Shopify stores. Native integration with no coding required.</p>
</div>
</div>
</div>
</div>` +
...
<div style="all:initial;display:block;position:relative;left:50%;right:50%;margin-left:-50vw;margin-right:-50vw;width:100vw;min-width:100vw;background:linear-gradient(135deg,#8E5DFF 0%,#6B42CC 100%);padding:60px 20px;box-sizing:border-box;overflow-x:hidden;font-family:'Open Sans',sans-serif;">
<div style="all:initial;display:block;max-width:900px;margin:0 auto;text-align:center;padding:0;box-sizing:border-box;">
<h2 style="all:initial;display:block;font-family:'Open Sans',sans-serif;font-weight:800;font-size:42px;line-height:1.3;color:#ffffff;margin:0 0 20px 0;padding:0;text-align:center;box-sizing:border-box;">Test #1 Works. So Do The Other 36.</h2>
<p style="all:initial;display:block;font-family:'Open Sans',sans-serif;font-size:18px;line-height:1.6;color:#f0e6ff;margin:0 0 40px 0;padding:0;text-align:center;font-weight:400;box-sizing:border-box;">Get all 37 proven tests with templates, data, and implementation guides.</p>
<button style="all:initial;display:block;margin:0 auto;padding:18px 50px;background:#ffffff;border:none;border-radius:50px;color:#8E5DFF;font-weight:800;font-size:18px;cursor:pointer;font-family:'Open Sans',sans-serif;box-sizing:border-box;transition:all 0.3s ease;" data-variant-id="43187792281693">GET INSTANT ACCESS - $29</button>
<p style="all:initial;display:block;font-family:'Open Sans',sans-serif;font-size:14px;line-height:1.5;color:#f0e6ff;margin:20px 0 0 0;padding:0;text-align:center;font-weight:400;box-sizing:border-box;">Lifetime access. One payment. No subscriptions.</p>
</div>
</div>`,
};
