...
The same frameworks in this course have been used to optimize 7-figure stores and generate millions in additional revenue. Now they're yours.`,
    ...
    bonuses: [
      {
        ...
        description:
          "We spent months fine-tuning AI capabilities to generate studio-grade model shots, product images, and lifestyle visuals that outperform real human photo shoots - and for FREE. You'll get full access to the complete course that teaches you how to create jaw-dropping product photos using AI.",
        value: 297,
      ...
      },
      {
        ...
        description:
          "We've already done the heavy lifting for you. We've assembled a secret vault of tools that give you a decisive, brutal advantage over your competitors. Frankly, we don't know how anyone builds a million-dollar brand without them.",
        value: 97,
      ...
      },
      {
        ...
        description:
          "And we didn't stop there... We partnered with dozens of eCommerce tools and top Shopify apps - the ones you already use - to give you MASSIVE lifetime discounts. On average, you'll save $40-$60/month on active subscriptions. Yes, really.",
        value: 97,
      ...
      },
      {
        ...
        description:
          'For months, we trained an AI agent to legally mimic the exact tactics used by billion-dollar brands - pixel by pixel, word by word. for FREE.',
        value: 97,
      ...
      },
      {
        ...
        description:
          "And here it is - one of the most essential tools. To give you the ultimate edge, we trained Einstein on Steroids for you. An AI brain powered by 180 IQ logic and timeless business wisdom. At the push of a button, it thinks what others can't - and together with you, will take your store to levels you never imagined.",
        value: 97,
      ...
      },
      {
        ...
        description:
          'Time to stop watching courses and hoping for change without truly implementing anything. The Personal Conversion Map gives you a guided tracking system that takes you step by step - all the way to success (6%+).',
        value: 147,
      ...
      },
      {
        ...
        description:
          'Unreleased insights, private test results, and weekly breakdowns from 7-8 figure brands. Delivered directly to you.',
        value: 97,
  ...
  'ltv-system': {
    ...
    description:
      'Transform one-time buyers into lifetime customers with automated systems that maximize customer lifetime value.',
    price: 10,
    originalPrice: 97,
    image:
      'https://quantum-scale.co/cdn/shop/files/LaserCRO-Coursemockups_58_efa8c3cd-aa72-4542-a933-0f433d8c01a1.jpg?v=1757325732',
    ...
    visuals: [
      {
        url: 'https://cdn.shopify.com/s/files/1/0682/3202/0061/files/007dff_5__gm_optimized.gif',
        caption: 'High-AOV orders flowing in automatically',
      },
      {
        url: 'https://cdn.shopify.com/s/files/1/0682/3202/0061/files/HOW_TO.gif',
        caption: 'The system working in real-time',
      },
    ],
...
Inside, you'll get the exact blueprints, templates, and automation recipes that took us years to perfect. Install them once, profit forever.`,
    modules: [
      {
        ...
        description:
          'Discover the psychological and technical system that makes every customer worth $1,000+. A backend architecture built to multiply profits automatically.',
      },
      {
        title: 'The Laws of Human Persuasion',
        description:
          'Harness the secret laws of human psychology that steer attention, trigger craving, and make customers load massive carts - again and again.',
      },
      {
        title: 'The Automation Loop Protocols',
        description:
          'Build the self-sustaining system that runs your business 24/7 — loyalty, upsells, emails, all working together to generate infinite LTV.',
      },
      {
        title: 'The Rebuy Technology System',
        description:
          'Master the brain loops that trigger automatic repeat purchases and oversized carts - used by luxury brands to multiply LTV effortlessly.',
      },
      {
        title: 'The Empire Growth Formula',
        description:
          'The scaling logic that lets you outspend competitors fearlessly - using psychology, math, and automation instead of luck.',
      },
    ],
    bonuses: [],
    faq: [
  ...
  'email-marketing': {
    ...
    description:
      'Steal the full billion-dollar email system that generates 20X more revenue than any social platform — without spending another dollar on ads.',
    price: 10,
    originalPrice: 97,
    ...
    visuals: [
      {
        url: 'https://cdn.shopify.com/s/files/1/0682/3202/0061/files/Satoshi_5.jpg?v=1762111646',
        caption: 'Email generates 20X more than social platforms',
      },
      {
        url: 'https://cdn.shopify.com/s/files/1/0682/3202/0061/files/crazy.png?v=1762107479',
        caption: 'Stop fighting the algorithm',
      },
    ],
    ...
    modules: [
      {
        ...
        description:
          'The most advanced BI configuration on the planet — optimizing send times, frequency, and content delivery on a per-customer basis. No more batch-and-blast. Every email hits when that specific person is most likely to convert.',
      },
      {
        title: 'System 2: Smart Automation Powered by AI + Data',
        description:
          'Automated systems that send hyper-personalized messages based on a fusion of massive behavioral data and AI-driven predictions. Each customer gets a tailored experience that feels handcrafted — but runs 100% on autopilot.',
      },
      {
        title: 'System 3: Precision-Engineered Email Copy',
        description:
          "Emails designed to strike the exact psychological trigger in each customer's mind — at the perfect moment — to convert them individually. No generic templates. Just proven frameworks that turn readers into buyers.",
      },
    ],
    bonuses: [],
    faq: [
      {
        ...
        answer:
          "You might know the basics — but this isn't about basics. This is about highly advanced tactics that take email marketing from 'nice to have' to 'impossible to compete with.' These are the systems that give billion-dollar brands a 10-step technological advantage over everyone else. If you're not using predictive BI, AI-powered personalization, and strategic automation, you're leaving 30X more value on the table.",
      },
      {
        question: "I don't think I need email marketing for my business.",
        answer:
          "Here's the reality: a properly built email automation system places you in an entirely different game. You'll harness technology correctly and deliver a ruthless, data-driven knockout to your competitors — without them even understanding why. Email isn't optional when you're competing against brands that generate billions. It's the most profitable channel most stores completely underutilize.",
      },
      {
      ...
      },
      {
        ...
        answer:
          "These systems are being used by businesses across every major industry — eCommerce, SaaS, services, digital products. If you have customers and email addresses, this works. And if for any reason you're not satisfied, you're protected by our 30-day money-back guarantee.",
      },
      {
        question: 'How is this different from other email marketing courses?',
        answer:
          "Most courses teach you how to write emails and set up basic automations. This teaches you the enterprise-level systems that billion-dollar brands use — predictive intelligence, AI personalization, advanced segmentation, and behavioral triggers. It's not about doing more email marketing. It's about doing it at a world-class level.",
      },
    ],
  },
  'abandoned-checkout': {
    ...
    description:
      'The system that recovers 82% of abandoned checkouts — automatically. Stop losing 75% of your potential revenue.',
    price: 10,
    originalPrice: 97,
    ...
    visuals: [
      {
        url: 'https://cdn.shopify.com/s/files/1/0682/3202/0061/files/007dff_1.jpg?v=1760514814',
        caption: 'Revenue recovery dashboard',
      },
    ],
...
This system stops the leak. It brings money back into your store. Every day. On autopilot.`,
    modules: [
      {
        ...
        description:
          'Each email goes out at the exact right time. When people are most likely to come back and buy.',
      },
      {
        title: 'Proven Psychology',
        description:
          'These emails were tested on hundreds of thousands of sends. Every word handles objections. Every line rebuilds trust. Every message pushes people to act.',
      },
      {
        title: 'Ready to Deploy',
        description:
          'The full 7-email sequence is ready. Copy, paste, done. No testing. No guessing. Just proven templates.',
      },
    ],
    bonuses: [],
    faq: [
      {
        ...
        answer:
          'Yes. The email sequence and strategy work universally across all e-commerce platforms. We provide specific integration guides for Shopify, WooCommerce, BigCommerce, and other major platforms to ensure seamless setup regardless of your tech stack.',
      },
      {
        question: 'Will I get lifetime access?',
        answer: 'Yes. One-time payment, lifetime access. No subscriptions. No hidden fees.',
  ...
  'the-social-proof': {
    ...
    description:
      'Turn every visitor into a buyer by triggering the most powerful force in human psychology — the Social Proof Effect.',
    price: 10,
    originalPrice: 197,
    ...
    visuals: [
      {
        url: 'https://cdn.shopify.com/s/files/1/0682/3202/0061/files/Whatever_it_takes_We_got_you_5.png?v=1742904328',
        caption: 'Before: ROAS 3.16 (Feb 2024)',
      },
      {
        url: 'https://cdn.shopify.com/s/files/1/0682/3202/0061/files/Whatever_it_takes_We_got_you_6.png?v=1742904467',
        caption: 'After: ROAS 27.13 (Mar 2024)',
      },
    ],
    ...
    modules: [
      {
        ...
        description:
          "You'll be exposed to every hidden psychological law that makes a random stranger buy simply because someone else did. Understand exactly how the brain works and what drives the subconscious to make a purchasing decision behind the scenes.",
      },
      {
        title: 'The Social Perception Engine',
        description:
          "The complete system for controlling the human brain's perception of your potential customer. Together, from zero, we'll build an entire framework that causes the customer to purchase in an impossible way, devoid of any ability to resist, due to the magical power called The Social Proof Effect.",
      },
      {
        title: 'The Subconscious Conversion Machine',
        description:
          'Discover how to transform doubt into belief, and belief into emotion. Learn how to trigger emotional responses in the customer that bypass logic — excitement so powerful it leads them to buy without thinking twice.',
      },
      {
        title: 'The Psychology of Certainty',
        description:
          "Here you learn how to make the customer's brain perceive reality exactly as you want. How to make them see your brand as the leader, your product as the only solution, and their purchase as the smartest decision they've ever made.",
      },
      {
        title: 'The Complete Dark Proof Protocol',
        description:
          "This is no longer persuasion — it's consciousness programming. Understand how to change the customer's deep beliefs about what 'works,' who's 'worthy,' and why you automatically become their safe and preferred choice again and again.",
      },
    ],
    bonuses: [],
    faq: [
      {
        ...
        answer:
          "Product page reviews are just the tip of the iceberg. This is a comprehensive psychological system that makes customers believe everything you say — across your ads, landing pages, emails, and entire funnel. It goes far beyond simple testimonials. You'll learn how to engineer belief at the subconscious level.",
      },
      {
        question: "This probably doesn't apply to my niche/business.",
        answer:
          "Wrong. This is relevant to everyone. Social proof is the fundamental law of human psychology. Any business applying it can skyrocket conversion rates overnight. Billion-dollar brands have built empires on this principle alone. If you're selling to humans, this applies to you.",
      },
      {
        question: 'What if I buy multiple courses — do they overlap?',
        answer:
          'Every course is designed to solve a specific part of the conversion equation. They complement each other without repeating, so stacking them creates compounding impact.',
      },
      {
        question: 'Will I get lifetime access?',
        answer: 'Yes. One-time payment, lifetime access. No subscriptions. No hidden fees.',
      ...
      },
      {
        ...
        answer:
          'Most people see an immediate impact on their ad performance within 24-72 hours of implementation. Social proof works instantly because it taps into hardwired human psychology.',
      },
      {
        question: 'What if Facebook shuts down my ad account?',
        answer:
          "That's exactly why you need this. Social proof is a skill that transcends platforms. Whether you're on Facebook, TikTok, Google, or selling in person — human psychology doesn't change. You'll own a skill that can't be taken away.",
      },
    ],
  },
  'product-mapping': {
    ...
    description:
      'Master the strategic product mapping framework used by billion-dollar brands to turn every product page into a high-converting sales machine.',
    price: 10,
    originalPrice: 197,
    ...
    modules: [
      {
        ...
        description:
          'Discover why giving customers the right number of choices dramatically increases conversions — and how to structure your offerings for maximum psychological impact.',
      },
      {
        title: 'The Billion-Dollar Mapping System',
        description:
          'The exact framework used by world-class brands to position products strategically. Learn how to create product ecosystems that naturally guide customers toward higher-value purchases.',
      },
      {
        title: 'The Strategic Product Mapping Framework',
        description:
          'A step-by-step system for analyzing, organizing, and presenting your products in ways that maximize perceived value and minimize decision friction.',
      },
      {
        title: 'The Anchor Product Effect',
        description:
          'Master the psychology of anchoring to make your core offerings feel like incredible deals — without discounting or cheapening your brand.',
      },
      {
        title: 'The Hidden Funnel Strategy',
        description:
          'Build invisible conversion paths that guide customers from browse to buy without aggressive selling. Turn your product catalog into an automated sales machine.',
      },
    ],
    bonuses: [],
    faq: [
      {
        ...
        answer:
          "Absolutely. The strategic mapping framework works whether you have 5 products or 500. In fact, smaller catalogs often see even bigger improvements because each product placement decision has more impact. You'll learn how to maximize every position in your store.",
      },
      {
        question: "I'm already getting sales. Do I really need this?",
        answer:
          "If you're getting sales without strategic product mapping, imagine what happens when you add it. Most stores see 30-50% increases in average order value alone. You're leaving significant money on the table if your products aren't strategically positioned.",
      },
      {
        question: 'Is this different from just organizing my store?',
        answer:
          "Completely different. Organization is about making products easy to find. Strategic mapping is about engineering purchase decisions. It's the difference between a grocery store and Apple's product lineup — both sell things, but one prints money.",
      },
      {
        question: 'What if I buy multiple courses — do they overlap?',
        answer:
      ...
      },
      {
        ...
        answer:
          "We want every serious eCommerce entrepreneur to have access to billion-dollar strategies — not just those with big budgets. At $39, this pays for itself with a single additional sale. Important: This price won't last forever. We reserve the right to increase it at any time.",
      },
    ],
  },
  'ab-test-results': {
    ...
    description:
      'Skip the guesswork. Apply what already works. Get instant access to 37 proven A/B tests that delivered 6% to 44% conversion improvements.',
    price: 10,
    originalPrice: 97,
    image:
      'https://quantum-scale.co/cdn/shop/files/LaserCRO-Coursemockups_42_9dbe83ef-43df-40d5-88eb-3cd7f29d394a.jpg?v=1757233262',
    ...
    visuals: [
      {
        url: 'https://cdn.shopify.com/s/files/1/0682/3202/0061/files/2.gif?v=1751796400',
        caption: 'Years of testing data',
      },
      {
        url: 'https://media.tenor.com/IQ6Z-aPhr1wAAAAM/date-everywhere-data.gif',
        caption: 'Data worth millions',
      },
    ],
    ...
    modules: [
      {
        ...
        description:
          'Simple tweaks to button copy delivered measurable lift — some as high as 18% improvement in click-through rates.',
      },
      {
        title: 'Page Structure Optimization',
        description:
          'Rearranging elements and adjusting layouts led to conversion improvements between 12% and 31% across different page types.',
      },
      {
        title: 'Messaging & Copy Tests',
        description:
          'Changes to headlines, value propositions, and messaging boosted conversions by up to 44% — the highest result in the collection.',
      },
    ],
    bonuses: [],
    faq: [
      {
        ...
        answer:
          "Yes. These are 37 fundamental tests relevant to virtually any website. Each one has been proven to increase conversions between 6% and 44%. Whether you're running e-commerce, SaaS, or lead generation — these principles apply universally because they're based on how humans make decisions.",
      },
      {
        question: 'What if I buy multiple courses — do they overlap?',
        answer:
      ...
      },
      {
        question: 'Is this just theory or can I apply it right away?',
        answer:
          "This is 100% practical. You'll get a clear XLS file with real test results and actionable insights that you can implement immediately. No fluff, no theory — just what worked, what didn't, and by how much.",
      },
      {
        question: 'Do I need a team to apply this?',
        answer:
          'Not at all. Every insight was designed for solo operators. You can implement everything with minimal tech skills or outsource it easily if you prefer. Most changes take minutes, not hours.',
      },
      {
        question: "How is this different from generic 'best practices' advice?",
        answer:
          "This isn't generic advice. This is real data from real tests run on high-traffic websites with tens (sometimes hundreds) of thousands of visitors per test. Every result is backed by statistical significance — not opinion or guesswork.",
      },
      {
        question: "What if I'm not satisfied?",
        answer:
          "We offer a full money-back guarantee. If you don't find value in these insights, just reach out and we'll refund you — no questions asked.",
      },
      {
        question: "Can I really see results 'starting today'?",
        answer:
          "Yes. These are proven changes you can implement immediately. Some take minutes to apply. The moment you make the change, you start benefiting from years of testing that's already been done for you.",
      },
    ],
  },
  'quiz-tactic': {
    ...
    description:
      'Steal the billion-dollar tactic that makes visitors 10X more likely to buy. Build conversion machines that generate 8-10% conversion rates consistently.',
    price: 10,
    originalPrice: 197,
    ...
    visuals: [
      {
        url: 'https://cdn.shopify.com/s/files/1/0682/3202/0061/files/9708718a5263943a338e9072eec122d5.gif?v=1742999762',
        caption: 'Stop the frustration of low conversions',
      },
      {
        url: 'https://cdn.shopify.com/s/files/1/0682/3202/0061/files/3be5a1c2fd9a8bd284bfabb6506ed8ce.gif?v=1742999766',
        caption: 'Watch your conversion rate go to the moon',
      },
    ],
    ...
    modules: [
      {
        ...
        description:
          "Discover why quizzes bypass logical resistance and tap directly into the buyer's emotional decision-making process. Learn the exact psychological triggers that make visitors 10X more likely to purchase.",
      },
      {
        title: 'Quiz Architecture Blueprint',
        description:
          'Get the proven question structure that elite brands use. Learn which questions to ask, in what order, and why each one builds unstoppable momentum toward the purchase.',
      },
      {
        title: 'Personalization Engine',
        description:
          "Master the art of making every visitor feel like you're speaking directly to them. Learn how to segment and recommend products with laser precision, dramatically increasing perceived value.",
      },
      {
        title: 'Implementation Templates',
        description:
          'No need to start from scratch. Get plug-and-play templates for fashion, beauty, supplements, and general eCommerce. Simply customize for your brand and deploy within hours.',
      },
      {
        title: 'Data Collection Strategy',
        description:
          'Learn how to ethically collect valuable customer data while delivering massive value. This data becomes pure gold for your email marketing, retargeting, and product development.',
      },
      {
        title: 'Conversion Optimization Secrets',
        description:
          "Discover the micro-optimizations that separate 3% conversion rates from 10%+ conversion rates. Every button placement, color choice, and word matters — and you'll know exactly what works.",
      },
    ],
    bonuses: [],
    faq: [
      ...
      },
      {
        ...
        answer:
          "The Quiz Tactic works for any eCommerce brand that sells to humans. Fashion, beauty, supplements, home goods, electronics — it doesn't matter. The psychology is universal. We've seen it transform conversion rates across dozens of niches.",
      },
      {
        question: 'What if I buy multiple courses — do they overlap?',
        answer:
      ...
      },
      {
        question: 'Will I get lifetime access?',
        answer:
          'Yes. One-time payment, lifetime access. No subscriptions. No hidden fees. You buy it once and own it forever, including all future updates.',
      },
      {
        question: 'Is this just theory or can I apply it right away?',
        answer:
          "This is 100% practical. You'll get a clear framework + real examples + plug & play templates that you can implement immediately. No fluff, no filler — just actionable strategies.",
      },
      {
        question: 'Do I need a team to apply this?',
        answer:
          'Not at all. Every tactic was designed for solo operators. You can implement everything with minimal tech skills or outsource it easily if you prefer. No developers required.',
      },
      {
        question: 'How long will it take to see results?',
        answer:
          "Most brands see measurable improvements within days of implementing the Quiz Tactic. The case study in this page? That brand saw results in less than a week. This isn't a slow-burn strategy — it's a rapid transformation tool.",
      },
      {
        question: "What if I'm not tech-savvy?",
        answer:
          "The templates are designed to be plug-and-play. If you can copy and paste, you can implement this. We've removed all technical barriers so you can focus on results, not code.",
      },
    ],
  },
  'laser-targeting': {
    ...
    description:
      "Inject steroids into Meta's AI and reach only people who match your product 100%. Stop burning money on audiences that will never buy.",
    price: 10,
    originalPrice: 197,
    image: 'https://quantum-scale.co/cdn/shop/files/LaserCRO-Coursemockups_45.jpg?v=1757233284',
    heroImage:
      'https://cdn.shopify.com/s/files/1/0682/3202/0061/files/2025-03-26T183609.222.png?v=1743008742',
    badge: 'Meta Ads',
    stats: [
    ...
    visuals: [
      {
        url: 'https://cdn.shopify.com/s/files/1/0682/3202/0061/files/rambo-shooting.gif?v=1743008740',
        caption: 'Precision targeting that hits every time',
      },
      {
        url: 'https://cdn.shopify.com/s/files/1/0682/3202/0061/files/2025-03-26T183609.222.png?v=1743008742',
        caption: 'Real results: 14.84 ROAS over 5 months',
      },
    ],
    ...
    modules: [
      {
        ...
        description:
          'Learn how to identify and reach the tiny fraction of people who will crave your product the second they see the ad. Stop wasting money on irrelevant impressions.',
      },
      {
        title: 'Meta AI Injection System',
        description:
          "Discover the exact data inputs that make Meta's algorithm obsessed with finding your perfect buyer. Train the AI to work for you 24/7.",
      },
      {
        title: 'Multi-Angle Attack Strategy',
        description:
          "Learn how to attack your audience from so many angles, it's nearly impossible for them to ignore you. Combine AI to pay less for better traffic.",
      },
      {
        title: 'The Avatar Mapping Protocol',
        description:
          'Target not by demographics, but by subconscious fears and desires. Go beyond surface-level targeting to psychological precision.',
      },
      {
        title: 'Remarketing Mastery',
        description:
          'Build remarketing sequences that feel like psychological compulsion. Generate 30-50% of your revenue from people who already showed interest.',
      },
      {
        title: 'The Bloodhound System',
        description:
          "Make Meta's AI work 24/7 like a bloodhound, hunting down ready-to-buy customers while you sleep. Set it and let it print money.",
      },
    ],
    bonuses: [],
    faq: [
      {
        ...
        answer:
          "No, you don't. What you know is the 3% that everyone teaches — the surface-level tactics. What we're revealing are secret, precise methods that tap into the remaining 97% of Meta's AI capabilities. If you already knew them, you'd already be running 10+ ROAS consistently.",
      },
      {
        question: 'What if I buy multiple courses — do they overlap?',
        answer:
          'Every course is designed to solve a specific part of the conversion equation. They complement each other without repeating content, so stacking them creates compounding impact. Laser Targeting focuses exclusively on reaching the right audience with surgical precision.',
      },
      {
        question: 'Will I get lifetime access?',
        answer:
          'Yes. One-time payment, lifetime access. No subscriptions. No hidden fees. Access it whenever you want, as many times as you want.',
      },
      {
        question: 'Is this just theory or can I apply it right away?',
        answer:
          "This is 100% practical. You'll get a clear framework + real examples + plug & play templates that you can implement immediately. No fluff, no theory for theory's sake.",
      },
      {
        question: 'Do I need a team to apply this?',
        answer:
      ...
      },
      {
        ...
        answer:
          "Every product has an audience. There are 8 billion people on this planet. Even if your product is 'weird' or 'niche,' there are thousands who want it. The Laser Targeting method works for any product because it's about finding YOUR specific buyers.",
      },
      {
        question: 'How long does it take to see results?',
        answer:
          'Most people see improvements within the first week of implementation. Some see dramatic results within 48-72 hours. The tactics are designed for fast implementation and quick wins.',
      },
    ],
  },
  'ai-photographer': {
    ...
    description:
      'Stop paying $10,000 for product photography. Generate studio-grade model shots, product images, and lifestyle visuals that outperform real human photo shoots — completely free with AI.',
    price: 10,
    originalPrice: 97,
    image: 'https://quantum-scale.co/cdn/shop/files/LaserCRO-Coursemockups_54.jpg',
    heroImage:
      'https://cdn.shopify.com/s/files/1/0682/3202/0061/files/7c40abec-7cfc-4805-9c1d-5290a3fd3afa.png',
    badge: 'AI Tool',
    stats: [
    ...
    visuals: [
      {
        url: 'https://cdn.shopify.com/s/files/1/0682/3202/0061/files/7c40abec-7cfc-4805-9c1d-5290a3fd3afa.png',
        caption: 'AI-generated product photography',
      },
    ],
    ...
    modules: [
      {
        ...
        description:
          'Master the core concepts of AI image generation. Learn which tools to use, how to write prompts that produce professional results, and the secrets to consistent brand imagery.',
      },
      {
        title: 'Product Photography Mastery',
        description:
          'Generate stunning product shots on any background. Learn lighting techniques, composition rules, and post-processing workflows that make AI images indistinguishable from professional photography.',
      },
      {
        title: 'Model & Lifestyle Shots',
        description:
          'Create photorealistic model shots and lifestyle scenes without hiring anyone. Master the art of generating humans, poses, and environments that sell your products.',
      },
      {
        title: 'Brand Consistency System',
        description:
          'Build a system for producing consistent imagery across your entire product catalog. Create style guides, prompt templates, and workflows that scale.',
      },
    ],
    bonuses: [],
    faq: [
      {
        ...
        answer:
          'Not at all. This course is designed for complete beginners. If you can type, you can create professional product images. We provide exact prompts and step-by-step instructions that anyone can follow.',
      },
      {
        question: 'What AI tools do I need?',
        answer:
          "We show you how to use free AI tools that produce professional results. No expensive software subscriptions required. Everything you need is either free or has a free tier that's more than enough for most stores.",
      },
      {
        question: 'Will AI images look fake or obvious?',
        answer:
          'When done correctly, AI images are indistinguishable from professional photography. In fact, many AI-generated images now outperform real photos in conversion tests. We teach you the techniques that make images look 100% real.',
      },
      {
        question: 'Can I use these images commercially?',
        answer:
          'Yes. The images you generate are yours to use however you want — on your website, in ads, on social media, anywhere. We also cover the legal aspects and best practices for commercial AI image use.',
      },
      {
        question: 'How long does it take to create an image?',
        answer:
          'Once you know the techniques, you can generate a professional product image in under 10 seconds. Creating a full product line with multiple angles and lifestyle shots takes minutes, not days.',
      },
      {
        question: 'Will this work for my specific product type?',
        answer:
          "Yes. Whether you're selling fashion, electronics, home goods, beauty products, or anything else — the AI techniques work universally. We include examples and prompts for all major product categories.",
      },
      {
        question: 'What if I buy multiple courses — do they overlap?',
        answer:
          'Every course is designed to solve a specific part of the eCommerce equation. They complement each other without repeating content, so combining them creates compounding results.',
      },
      {
        question: 'Will I get lifetime access?',
        answer:
          "Yes. One-time payment, lifetime access. No subscriptions. No hidden fees. Plus you'll receive all future updates as AI technology evolves.",
      },
      {
        question: "What if I'm not satisfied?",
        answer:
          "We offer a full money-back guarantee. If you don't find value in this course, just reach out and we'll refund you — no questions asked.",
      },
    ],
  },
  'meta-ad-templates': {
    ...
    description:
      'Stop wasting 6 hours to find one winning creative. Get instant access to 1,000+ proven Meta ad templates that are battle-tested on massive budgets.',
    price: 10,
    originalPrice: 97,
    image: 'https://quantum-scale.co/cdn/shop/files/LaserCRO-Coursemockups_59.jpg?v=1757325725',
    heroImage:
      'https://cdn.shopify.com/s/files/1/0682/3202/0061/files/6574469f-6304-4b63-a8a5-9d260fc2739a.png?v=1760535779',
    badge: 'Templates',
    stats: [
    ...
    visuals: [
      {
        url: 'https://cdn.shopify.com/s/files/1/0682/3202/0061/files/canvagif1.webp?v=1752485872',
        caption: 'Step 1: Choose your template',
      },
      {
        url: 'https://cdn.shopify.com/s/files/1/0682/3202/0061/files/canvagif2.gif?v=1752485913',
        caption: 'Step 2: Customize in Canva',
      },
      {
        url: 'https://cdn.shopify.com/s/files/1/0682/3202/0061/files/canvagif3.gif?v=1752485958',
        caption: 'Step 3: Launch & Scale',
      },
    ],
    ...
    modules: [
      {
        ...
        description:
          'Pick from 1,000+ expertly designed static ad templates in Canva. Every template is battle-tested and proven to convert.',
      },
      {
        title: 'Customize in Canva',
        description:
          'Edit your template in seconds with your logo, colors, and copy. Simple drag-and-drop. No design experience needed.',
      },
      {
        title: 'Launch & Scale',
        description:
          'Download your ad from Canva and launch it in Ads Manager. Watch your ROAS climb while your competitors struggle with creative testing.',
      },
    ],
    bonuses: [],
    faq: [
      {
        ...
        answer:
          'Absolutely not. Every template is designed for drag-and-drop editing in Canva. If you can click and type, you can create stunning ad creatives. No design experience required.',
      },
      {
        question: 'Will these templates work for my niche/product?',
        answer:
          "Yes. The templates cover a wide variety of styles, layouts, and formats that work across virtually every niche. From fashion to electronics, supplements to home goods - you'll find templates that fit your brand.",
      },
      {
        question: 'Do I need to pay for Canva Pro?',
        answer:
          "No. All templates work perfectly with Canva's free version. Zero additional software costs. You can start using them immediately without any subscriptions.",
      },
      {
        question: 'How are these different from free templates online?',
        answer:
          "These templates are battle-tested on real ad campaigns with massive budgets. They're not generic designs - they're proven winners that have generated real results. Free templates online are untested guesses. These are data-backed performers.",
      },
      {
        question: 'What if I buy multiple courses - do they overlap?',
        answer:
          'Every course and tool is designed to solve a specific part of the advertising equation. They complement each other without repeating content, so combining them creates compounding results.',
      },
      {
        question: 'Will I get lifetime access?',
        answer:
          "Yes. One-time payment, lifetime access. No subscriptions. No hidden fees. Plus you'll receive any future template additions at no extra cost.",
      },
      {
        question: 'How quickly can I start using the templates?',
        answer:
          "Instantly. After purchase, you'll get immediate access to the entire library. You can have your first ad creative ready in under 60 seconds.",
      },
      {
        question: "What if I'm not satisfied?",
        answer:
          "We offer a full money-back guarantee. If you don't find value in these templates, just reach out and we'll refund you — no questions asked.",
      },
    ],
  },
  'ad-copy-templates': {
    ...
    description:
      'Steal the exact ad copy frameworks from copywriters who charge $50,000 per sales letter. Templates tested on over $10 million in ad spend.',
    price: 10,
    originalPrice: 97,
    ...
    visuals: [
      {
        url: 'https://cdn.shopify.com/s/files/1/0682/3202/0061/files/007dff_9.jpg',
        caption: 'Ad copy that converts',
      },
    ],
    ...
    modules: [
      {
        ...
        description:
          '15+ proven headline templates that stop the scroll. Each formula is designed to trigger curiosity and demand attention in a crowded newsfeed.',
      },
      {
        title: 'Hook Structures',
        description:
          'Opening lines that grab attention in the first 3 seconds. These hooks are engineered to make people stop scrolling and start reading.',
      },
      {
        title: 'Story Frameworks',
        description:
          'Narrative structures that build emotional connection and desire. Turn features into feelings that drive purchases.',
      },
      {
        title: 'CTA Templates',
        description:
          'Call-to-action formulas that compel immediate action. Remove friction and make clicking feel like the obvious next step.',
      },
    ],
    bonuses: [],
    faq: [
      {
        ...
        answer:
          'Not at all. Every template is fill-in-the-blank simple. Just insert your product details, benefits, and brand voice. The psychological structure is already built in — you just add your specifics.',
      },
      {
        question: 'Will these work for my specific product/niche?',
        answer:
          'Yes. These are universal frameworks based on human psychology — not niche-specific tricks. Whether you sell fashion, supplements, electronics, or services, these templates work because they tap into fundamental buying triggers.',
      },
      {
        question: 'How are these different from free templates online?',
        answer:
          'Free templates online are generic and untested. These templates are directly inspired by copywriters who charge $15,000-$50,000 per letter and have been tested on over $10 million in real ad spend. The difference shows in your results.',
      },
      {
        question: 'Can I use these for Facebook, Instagram, and TikTok ads?',
        answer:
          'Absolutely. These copy frameworks work across all platforms. We include variations optimized for different placements — feed ads, stories, reels, and more.',
      },
      {
        question: 'What if I buy multiple courses — do they overlap?',
        answer:
          'Every course is designed to solve a specific part of the advertising equation. They complement each other without repeating content, so combining them creates compounding results.',
      },
      {
        question: 'Will I get lifetime access?',
        answer:
      ...
      },
      {
        ...
        answer:
          'Immediately. After purchase, you get instant access to all 50+ templates. You can have your first ad copy ready in minutes.',
      },
      {
        question: "What if I'm not satisfied?",
        answer:
