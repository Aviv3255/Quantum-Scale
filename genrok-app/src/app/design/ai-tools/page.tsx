...
import { X, ExternalLink, Brain, Palette, TrendingUp, Cog, LucideIcon } from 'lucide-react';
...
const tools: Tool[] = [
  {
    ...
    description:
      'ShopHunter is the private research engine used by top Shopify sellers. It continuously scans tens of thousands of Shopify stores in real time and reveals exactly which products are breaking out, the selling prices, and estimated revenue by brand.',
    videos: [
  ...
  },
  {
    ...
    description:
      'AdCreative.ai fundamentally upgrades how you produce ads. In seconds, it generates dozens of high-converting creatives - premium layouts, persuasive copy, and on-the-fly performance insights.',
    videos: [
  ...
  },
  {
    ...
    description:
      'Triple Whale is the most advanced analytics OS for eCommerce - uniting Meta, Google, and Shopify data into a single source of truth. Its AI layer highlights what truly drives profit versus what silently burns budget.',
    videos: [
  ...
  },
  {
    ...
    description:
      'Creatify lets you produce conversion-ready ad videos in minutes - no cameras, crews, or actors. It auto-generates authentic UGC for TikTok, Meta, and Reels, complete with human presenters.',
    videos: [
  ...
  },
  {
    ...
    description:
      'HeyGen transforms any script into a full video featuring lifelike presenters in the language of your choice. From how-to tutorials and product explainers to high-trust ads.',
    videos: [
  ...
  },
  {
    ...
    description:
      'WinningHunter is your personal scout for breakout products. It monitors AliExpress, TikTok, and Shopify in real time, detects emerging trends, and scores opportunities.',
    videos: [
  ...
  },
  {
    ...
    description:
      'Claid.ai is the ultimate visual upgrade for product imagery. With a single click it fixes lighting, sharpness, backgrounds, and composition - instantly elevating your store and ads.',
    videos: [
  ...
  },
  {
    ...
    description:
      'Hoppy Copy is an AI copywriter engineered for persuasion and widely regarded as the best AI copywriter in the world. It crafts sales pages, emails, and ads grounded in buyer psychology - trust, urgency, social proof, and value framing.',
    videos: [
  ...
  },
  {
    ...
    description:
      'ElevenLabs converts any script into a studio-quality human voice. From performance ads and UGC to courses and brand narrations.',
    videos: [
    ...
    <DashboardLayout>
      <div className="page-wrapper">
        <div className="mb-6 md:mb-8">
          <h1
            className="mb-2 text-3xl font-bold md:mb-3 md:text-4xl"
            style={{
              color: '#1E1E1E',
        ...
        <div className="mb-6 flex flex-wrap gap-2 md:mb-8 md:gap-3">
          {categories.map((cat) => {
            ...
            return (
              <button
                ...
                className="flex items-center gap-2 rounded-xl px-4 py-2.5 text-sm font-medium transition-all md:px-5 md:py-3 md:text-base"
                style={{
                  background: isActive
          ...
          {selectedCategories.length > 0 && (
            <button
              ...
              className="rounded-xl px-4 py-2.5 text-sm font-medium transition-all md:px-5 md:py-3"
              style={{
                background: '#FFFFFF',
          ...
          {filteredTools.map((tool) => (
            ...
            >
              ...
              <div className="absolute left-2 top-2 z-10 md:left-4 md:top-4">
                <div
                  className="rounded-full px-2 py-1 text-[10px] font-semibold md:px-3 md:text-xs"
              ...
              <div className="p-2 md:p-4">
                <h3
                  className="line-clamp-2 text-xs font-semibold md:text-base lg:text-lg"
                  style={{ color: '#1E1E1E' }}
                >
                  {tool.name}
                </h3>
        ...
        {selectedTool && (
          ...
          >
            <div
              className="relative max-h-[85vh] w-full max-w-xl overflow-y-auto rounded-2xl md:max-w-2xl"
            ...
            >
              <button
                onClick={() => setSelectedTool(null)}
                className="absolute right-4 top-4 z-10 rounded-full p-2 text-gray-700 transition-all hover:bg-gray-100"
              ...
              <div className="p-5 md:p-6">
                ...
                <p
                  className="mb-4 text-sm leading-relaxed md:mb-5 md:text-base"
                  style={{ color: '#6B7280' }}
                >
                ...
                {selectedTool.videos && selectedTool.videos.length > 0 && (
                  <div className="mb-4 md:mb-5">
                    <h3
                      className="mb-2 text-xs font-semibold md:mb-3 md:text-sm"
                      style={{ color: '#1E1E1E' }}
                    >
                      Demo Videos
                    </h3>
                    <div className="flex flex-wrap gap-2">
                      {selectedTool.videos.map((video, idx) => (
                        <video
                          ...
                          style={{ aspectRatio: '9/16', width: '100px', maxWidth: '120px' }}
                        />
                      ))}
                    </div>
                  </div>
                ...
                <a
                  ...
                  className="inline-flex items-center gap-2 rounded-xl px-4 py-2 text-sm font-medium transition-all md:px-6 md:py-3 md:font-semibold"
                  style={{
