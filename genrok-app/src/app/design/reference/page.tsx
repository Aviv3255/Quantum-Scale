...
const PAGES_DATA: PageData[] = [
  {
    ...
    blocks: [
      { id: 1, name: 'Geo Announcement Bar', description: 'Geo-targeted announcement with personalized discount based on visitor\'s country + local holiday. Increases conversion by 60-70%.', y_position: -46, mobile_y_position: 26, side: 'right', install_link: 'https://geo-convert.com', completed: false },
      ...
      { id: 4, name: 'Collection Grid/Slider', description: 'Section name: Slider #7', y_position: 527, mobile_y_position: 746, side: 'left', install_link: 'https://apps.shopify.com/section-factory?mref=lsbqcbva', completed: false },
      ...
      { id: 7, name: 'All Collections View', description: 'Section name: Collection #5', y_position: 1500, mobile_y_position: 2311, side: 'right', install_link: 'https://apps.shopify.com/section-factory?mref=lsbqcbva', completed: false },
      ...
      { id: 10, name: 'Geo Location Banner', description: 'Section name: Square banner', y_position: 2040, mobile_y_position: 3765, side: 'left', install_link: 'https://geo-convert.com', completed: false },
  ...
  },
  {
    ...
    blocks: [
      { id: 1, name: 'Geo Announcement Bar', description: 'Geo-targeted announcement with personalized discount based on visitor\'s country + local holiday. Increases conversion by 60-70%.', y_position: 4, mobile_y_position: 43, x_position: 76, mobile_x_position: 100, side: 'right', install_link: 'https://geo-convert.com', completed: false },
      { id: 2, name: 'Header', description: 'Section name: Header #11', y_position: 19, mobile_y_position: 132, x_position: 4, mobile_x_position: 9, side: 'left', install_link: 'https://apps.shopify.com/section-factory?mref=lsbqcbva', completed: false },
      ...
      { id: 4, name: 'Low Stock Alert', description: 'Fake "low stock available" for specific variants. Use for best sellers. Increases CVR by 25-45%.', y_position: 154, mobile_y_position: 675, x_position: 71, mobile_x_position: 33, side: 'right', install_link: '#', completed: false },
      { id: 5, name: 'Wishlist', description: 'Save products to wishlist functionality.', y_position: 196, mobile_y_position: 727, x_position: 99, mobile_x_position: 86, side: 'right', install_link: 'https://vitals.app/shopify/12548540', completed: false },
