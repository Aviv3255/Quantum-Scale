...
const PAGES_DATA: PageData[] = [
  {
    ...
    blocks: [
      { id: 1, name: 'Geo Announcement Bar', description: 'Geo-targeted announcement with personalized discount based on visitor\'s country + local holiday. Increases conversion by 60-70%.', y_position: -45, mobile_y_position: 26, side: 'right', install_link: 'https://geo-convert.com', completed: false },
      { id: 2, name: 'Transparent Header', description: 'Section name: Header #11', y_position: 49, mobile_y_position: 105, side: 'left', install_link: 'https://apps.shopify.com/section-factory?mref=lsbqcbva', completed: false },
      ...
      { id: 4, name: 'Collection Grid/Slider', description: 'Section name: Slider #7', y_position: 547, mobile_y_position: 746, side: 'left', install_link: 'https://apps.shopify.com/section-factory?mref=lsbqcbva', completed: false },
  ...
  },
  {
    ...
    blocks: [
      { id: 1, name: 'Geo Announcement Bar', description: 'Geo-targeted announcement with personalized discount based on visitor\'s country + local holiday. Increases conversion by 60-70%.', y_position: -46, mobile_y_position: 43, x_position: 76, mobile_x_position: 100, side: 'right', install_link: 'https://geo-convert.com', completed: false },
      { id: 2, name: 'Header', description: 'Section name: Header #11', y_position: 7, mobile_y_position: 132, x_position: 4, mobile_x_position: 9, side: 'left', install_link: 'https://apps.shopify.com/section-factory?mref=lsbqcbva', completed: false },
      { id: 3, name: 'Product Reviews', description: 'Customer reviews and ratings display.', y_position: -131, mobile_y_position: 541, x_position: 69, mobile_x_position: 85, side: 'right', install_link: 'https://loox.io/app/LASERCRO', completed: false },
      { id: 4, name: 'Low Stock Alert', description: 'Fake "low stock available" for specific variants. Use for best sellers. Increases CVR by 25-45%.', y_position: 194, mobile_y_position: 675, x_position: 71, mobile_x_position: 33, side: 'right', install_link: '#', completed: false },
      { id: 5, name: 'Wishlist', description: 'Save products to wishlist functionality.', y_position: 236, mobile_y_position: 727, x_position: 99, mobile_x_position: 86, side: 'right', install_link: 'https://vitals.app/shopify/12548540', completed: false },
      { id: 6, name: 'Product Videos', description: 'Section name: Product videos', y_position: 415, mobile_y_position: 973, x_position: 97, mobile_x_position: 24, side: 'right', install_link: 'https://apps.shopify.com/section-factory?mref=lsbqcbva', completed: false },
      { id: 7, name: 'Product Description Tabs', description: 'Section name: Product tabs #5 pro', y_position: 578, mobile_y_position: 1211, x_position: 98, mobile_x_position: 98, side: 'right', install_link: 'https://apps.shopify.com/section-factory?mref=lsbqcbva', completed: false },
      { id: 8, name: 'Product Highlight Block', description: 'Section name: Feature #19', y_position: 835, mobile_y_position: 1623, x_position: 17, mobile_x_position: 82, side: 'left', install_link: 'https://apps.shopify.com/section-factory?mref=lsbqcbva', completed: false },
      { id: 9, name: 'Featured Collection', description: 'Section name: Featured collection #18', y_position: 1108, mobile_y_position: 2261, x_position: 16, mobile_x_position: 44, side: 'left', install_link: 'https://apps.shopify.com/section-factory?mref=lsbqcbva', completed: false },
      { id: 10, name: 'Collections Grid', description: 'Section name: Collections #5', y_position: 1390, mobile_y_position: 2770, x_position: 92, mobile_x_position: 97, side: 'right', install_link: 'https://apps.shopify.com/section-factory?mref=lsbqcbva', completed: false },
      { id: 11, name: 'Product Reviews Section', description: 'Full product reviews section.', y_position: 1709, mobile_y_position: 3078, x_position: 17, mobile_x_position: 44, side: 'left', install_link: 'https://loox.io/app/LASERCRO', completed: false },
      { id: 12, name: 'Footer', description: 'Section name: Footer #7', y_position: 2125, mobile_y_position: 4226, x_position: 77, mobile_x_position: 68, side: 'right', install_link: 'https://apps.shopify.com/section-factory?mref=lsbqcbva', completed: false },
    ],
  },
  {
    page: 'cart',
  ...
  },
  {
    ...
    blocks: [
      { id: 1, name: 'Geo Announcement Bar', description: 'Geo-targeted announcement with personalized discount based on visitor\'s country + local holiday. Increases conversion by 60-70%.', y_position: 20, mobile_y_position: 39, side: 'right', install_link: 'https://geo-convert.com', completed: false },
