...
const PAGES_DATA: PageData[] = [
  {
    ...
    blocks: [
      { id: 1, name: 'Geo Announcement Bar', description: 'Geo-targeted announcement with personalized discount based on visitor\'s country + local holiday. Increases conversion by 60-70%.', y_position: 9, mobile_y_position: 26, side: 'right', install_link: 'https://geo-convert.com', completed: false },
  ...
  },
  {
    ...
    blocks: [
      { id: 1, name: 'Geo Announcement Bar', description: 'Geo-targeted announcement with personalized discount based on visitor\'s country + local holiday. Increases conversion by 60-70%.', y_position: 9, mobile_y_position: 43, x_position: 100, mobile_x_position: 100, side: 'right', install_link: 'https://geo-convert.com', completed: false },
      ...
      { id: 6, name: 'Product Videos', description: 'Section name: Product videos', y_position: 360, mobile_y_position: 973, x_position: 24, mobile_x_position: 24, side: 'right', install_link: 'https://apps.shopify.com/section-factory?mref=lsbqcbva', completed: false },
