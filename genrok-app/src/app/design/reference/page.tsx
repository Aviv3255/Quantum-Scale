...
const PAGES_DATA: PageData[] = [
  ...
  },
  {
    ...
    blocks: [
      { id: 1, name: 'Geo Announcement Bar', description: 'Geo-targeted announcement with personalized discount based on visitor\'s country + local holiday. Increases conversion by 60-70%.', y_position: 14, mobile_y_position: 93, x_position: 76, mobile_x_position: 100, side: 'right', install_link: 'https://geo-convert.com', completed: false },
      { id: 2, name: 'Header', description: 'Section name: Header #11', y_position: 52, mobile_y_position: 142, x_position: 4, mobile_x_position: 9, side: 'left', install_link: 'https://apps.shopify.com/section-factory?mref=lsbqcbva', completed: false },
      { id: 3, name: 'Product Reviews', description: 'Customer reviews and ratings display.', y_position: 119, mobile_y_position: 571, x_position: 69, mobile_x_position: 85, side: 'right', install_link: 'https://loox.io/app/LASERCRO', completed: false },
      { id: 4, name: 'Low Stock Alert', description: 'Fake "low stock available" for specific variants. Use for best sellers. Increases CVR by 25-45%.', y_position: 219, mobile_y_position: 705, x_position: 71, mobile_x_position: 33, side: 'right', install_link: '#', completed: false },
      { id: 5, name: 'Wishlist', description: 'Save products to wishlist functionality.', y_position: 250, mobile_y_position: 757, x_position: 99, mobile_x_position: 86, side: 'right', install_link: 'https://vitals.app/shopify/12548540', completed: false },
      { id: 6, name: 'Product Videos', description: 'Section name: Product videos', y_position: 415, mobile_y_position: 983, x_position: 97, mobile_x_position: 24, side: 'right', install_link: 'https://apps.shopify.com/section-factory?mref=lsbqcbva', completed: false },
